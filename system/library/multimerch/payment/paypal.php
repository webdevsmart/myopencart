...
class Paypal {
    ...
    */
	public function request($method,$params = array(),$log_filename = false) {
      $this -> _errors = array();
	...
	public function preapproval_request($params,$request_url) {
   ...
   public function validateIPN($log_filename) {
