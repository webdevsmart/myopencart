      ...
      <div class="row login-content">
          ...
          <div class="well">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="control-label" for="input-email" style="line-height:2.5;"><?php echo $entry_email; ?></label>
                <input type="text" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" />
              </div>
              <div class="form-group">
                <label class="control-label" for="input-password" style="line-height:2.5;"><?php echo $entry_password; ?></label>
                <input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control" />
                <a href="<?php echo $forgotten; ?>" style="line-height: 3.5;"><?php echo $text_forgotten; ?></a></div>
                </div>
              <br /><hr/>
        ...
        <div class="col-sm-6 right">
          <div class="well">
            ...
            <div class="login-wrap">
            <p><strong><?php echo $text_register; ?></strong></p><br />
