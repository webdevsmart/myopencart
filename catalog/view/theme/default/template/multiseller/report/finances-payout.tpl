	...
	<div class="row"><?php echo $column_left; ?>
		...
		<div id="content" class="<?php echo $class; ?> ms-account-dashboard"><?php echo $content_top; ?>
			<div class="mm_dashboard">
				<h1 class="pull-left"><i class="fa fa-list"></i><?php echo $ms_report_finances_payout; ?></h1>
				...
				<div id="tab-report-sales">
					<div class="table-responsive">
						<table class="mm_dashboard_table table table-borderless table-hover" id="list-report-finances-payout">
							<thead>
								<tr>
