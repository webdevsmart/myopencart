...
$_['text_new_greeting']         = 'Thank you for your interest in %s. Your order has been received and we will be in contact with you to confirm delivery date and time. We are currently experiencing a high demand for our services. Your order is very important to us and it will be placed in sequential order to be fulfilled. Products that are priced based on weight will be subject to vary. Exact price will be determined upon delivery, and may vary slightly from the checkout price online.</br></br>During these unprecedented times, orders may take up to 1 week to complete.';
