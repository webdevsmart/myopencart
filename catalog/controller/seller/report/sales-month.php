...
class ControllerSellerReportSalesMonth extends ControllerSellerReport {

	public function index() {
		$this->document->addScript('catalog/view/javascript/multimerch/report/sales-month.js');

		$this->document->setTitle($this->language->get('ms_report_sales_month'));
		...
		$this->data['breadcrumbs'] = $this->MsLoader->MsHelper->setBreadcrumbs(array(
			...
			array(
				'text' => $this->language->get('ms_report_sales') . " - " . $this->language->get('ms_report_sales_month'),
				'href' => $this->url->link('seller/report/sales-month', '', 'SSL')
			)
		));

		list($template, $children) = $this->MsLoader->MsHelper->loadTemplate('multiseller/report/sales-month');
