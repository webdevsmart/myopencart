...
class ControllerSellerReportFinancesPayment extends ControllerSellerReport {

	public function index() {
		$this->document->addScript('catalog/view/javascript/multimerch/report/finances-payment.js');

		$this->document->setTitle($this->language->get('ms_report_finances_payment'));
		...
		$this->data['breadcrumbs'] = $this->MsLoader->MsHelper->setBreadcrumbs(array(
			...
			array(
				'text' => $this->language->get('ms_report_finances') . " - " . $this->language->get('ms_report_finances_payment'),
				'href' => $this->url->link('seller/report/finances-payment', '', 'SSL')
			)
		));

		list($template, $children) = $this->MsLoader->MsHelper->loadTemplate('multiseller/report/finances-payment');
