...
.well-days, .well-desc, .product-category, .product-product, .product-option, .product-manufacturer, .hide-methods{ display:block;}
div.category, div.product, div.option, div.postal-option, div.range-option, div.coupon-option, div.manufacturer, div.dimensional-option, div.city-option{ display:none;}
label.any-class {
    margin-top: 4px;
}
...
var tmp='<div id="__ID__" class="tab-pane shipping">'
          ...
          +'<ul class="nav nav-tabs" id="language__INDEX__">'
            <?php $inc=0; foreach ($languages as $language) { $active_cls=($inc==0)?'class="active"':''; $inc++; ?>
             +'<li <?php echo $active_cls; ?> ><a href="#language<?php echo $language['language_id']; ?>___INDEX__" data-toggle="tab"><img src="<?php echo $language_dir.$language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>'
            <?php } ?>
          +' </ul>'
		  +'<div class="tab-content">'
         <?php $inc=0;foreach ($languages as $language) { $active_cls=($inc==0)?' active':''; $lang_cls=($inc==0)?'':'-lang'; $inc++;  ?>
          +'<div class="tab-pane<?php echo $active_cls;?>" id="language<?php echo $language['language_id']; ?>___INDEX__">'
		    +'<div class="form-group required">'
      ...
      +'<ul class="nav nav-tabs method-tab" id="method-tab-__INDEX__">'
           ...
           +'<div class="tab-pane active" id="common___INDEX__">'
            ...
            +'<div class="tab-pane" id="criteria___INDEX__">'
               ...
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label" for="input-city__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_city)?>"><?php echo $text_city; ?></span></label>' 
                 +'<div class="col-sm-10">'
                +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[city_all]" class="choose-any-with" rel="city-option" value="1" id="input-city__INDEX__" /><?php echo $text_any; ?></label>'
              +'</div>'
               +'</div>'
               +'<div class="form-group city-option">'
                +'<label class="col-sm-2 control-label" for="input-city_data__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($text_city_enter_tip)?>"><?php echo $text_city_enter?></span></label>'
                +'<div class="col-sm-10"><textarea class="form-control" id="input-city_data__INDEX__" name="xshippingpro[city]" rows="8" cols="70" /></textarea></div>'
               +'</div>'
               +'<div class="form-group city-option">'
                +'<label class="col-sm-2 control-label" for="input-city-rule__INDEX__"><?php echo $text_city_rule?></label>'
                +'<div class="col-sm-10"><select class="form-control" id="input-city-rule__INDEX__" name="xshippingpro[city_rule]">'
                    +'<option value="inclusive"><?php echo $text_city_rule_inclusive?></option>'
                    +'<option value="exclusive"><?php echo $text_city_rule_exclusive?></option>'
                  +'</select></div>'
               +'</div>'  
               
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($text_country_tip)?>"><?php echo $text_country; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            ...
		            +'<div class="well well-sm" style="height: 115px; overflow: auto;">'
		            +'<div class="checkbox xshipping-checkbox">'
                     <?php 
                    foreach ($countries as $country) {
                     ?>
                     +'<label>'
                         +'<input type="checkbox" name="xshippingpro[country][]" value="<?php echo $country['country_id']; ?>" /><?php echo addslashes(trim($country['name'])); ?>'
                    +'</label>'
                    <?php } ?>
				   +'</div></div>'
	            +'</div>'
               ...
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_payment)?>"><?php echo $entry_payment; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[payment_all]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
		            +'<div class="well well-sm" style="height: 70px; overflow: auto;">'
		             +'<div class="checkbox xshipping-checkbox">'
                     <?php 
               ...
               +'<div class="form-group coupon-option">'
                +'<label class="col-sm-2 control-label" for="input-coupon-here__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($text_coupon_tip)?>co"><?php echo $text_enter_coupon?></span></label>'
        ...
        +'</div>'
        +'<div class="form-group">'
              +'<label class="col-sm-2 control-label" for="input-manufacturer_rule__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_manufacturer_rule)?>"><?php echo $text_manufacturer_rule; ?></span></label>'
              +'<div class="col-sm-10"><select id="input-manufacturer_rule__INDEX__" class="form-control selection" rel="manufacturer" name="xshippingpro[manufacturer_rule]">'
                  +'<option value="1"><?php echo $text_manufacturer_any; ?></option>'
             ...
             +'</div>'
              ...
              +'<label class="col-sm-2 control-label" for="input-manufacturer__INDEX__"><?php echo $entry_manufacturer; ?></label>'
              +'<div class="col-sm-10"><input type="text" name="input_manufacturer" value="" placeholder="<?php echo $entry_manufacturer; ?>" id="input-manufacturer__INDEX__" class="form-control" />'
         ...
         +'<div class="tab-pane" id="price___INDEX__">'
            +'<div class="form-group">'
              ...
              +'<div class="col-sm-10"><select id="input-rate__INDEX__" class="rate-selection form-control" name="xshippingpro[rate_type]">'
                  ...
                  +'<option value="no_category"><?php echo $text_no_of_category?></option>'
                  +'<option value="no_manufacturer"><?php echo $text_no_of_manufacturers?></option>'
