			...
			<div class="panel-body tab-content">
				<div class="tab-pane active">
					<div class="table-responsive">
						<form class="form-inline" action="" method="post" enctype="multipart/form-data" id="form-reports-sales-month">
							<table class="list mmTable table table-bordered table-hover" id="list-reports-sales-month">
								<thead>
									<tr>
