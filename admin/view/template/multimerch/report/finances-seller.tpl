			...
			<div class="panel-body tab-content">
				<div class="tab-pane active">
					<div class="table-responsive">
						<form class="form-inline" action="" method="post" enctype="multipart/form-data" id="form-reports-finances-seller">
							<table class="list mmTable table table-bordered table-hover" id="list-reports-finances-seller">
								<thead>
									<tr>
										<td><?php echo $ms_report_column_seller; ?></td>
										<td><?php echo $ms_report_column_balance_in; ?></td>
										<td><?php echo $ms_report_column_balance_out; ?></td>
										<td><?php echo $ms_report_column_marketplace_earnings; ?></td>
										<td><?php echo $ms_report_column_seller_earnings; ?></td>
										<td><?php echo $ms_report_column_payments_received; ?></td>
										<td><?php echo $ms_report_column_payouts_paid; ?></td>
										<td><?php echo $ms_report_column_balance_current; ?></td>
									</tr>
								</thead>
								<tbody>
								</tbody>
