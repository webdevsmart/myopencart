			...
			<div class="panel-body tab-content">
				<div class="tab-pane active"">
					<div class="table-responsive">
						<form class="form-inline" action="" method="post" enctype="multipart/form-data" id="form-reports-sales-customer">
							<table class="list mmTable table table-bordered table-hover" id="list-reports-sales-customer">
								<thead>
									<tr>
										<td><?php echo $ms_report_column_customer; ?></td>
										<td><?php echo $ms_report_column_email; ?></td>
										<td><?php echo $ms_report_column_total_orders; ?></td>
