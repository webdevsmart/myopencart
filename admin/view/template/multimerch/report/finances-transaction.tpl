			...
			<div class="panel-body tab-content">
				<div class="tab-pane active">
					<div class="table-responsive">
						<form class="form-inline" action="" method="post" enctype="multipart/form-data" id="form-reports-finances-transaction">
							<table class="list mmTable table table-bordered table-hover" id="list-reports-finances-transaction">
								<thead>
									<tr>
										<td><?php echo $ms_report_column_date; ?></td>
										<td><?php echo $ms_report_column_transaction; ?></td>
