...
$_['text_ppa_log_filename'] = 'Error Log Filename';

$_['ppa_error_secondaryonly'] = 'The fee payer type PRIMARYRECEIVER can only be used for CHAINED payments';
$_['ppa_error_senderchained'] = 'The fee payer SENDER cannot be used for CHAINED payments';
$_['ppa_error_eachchained'] = 'The fee payer EACHRECEIVER cannot be used for CHAINED payments';
$_['ppa_error_preapproval_eachreceiver'] = 'The PREAPPROVAL payment can only be used with fee payer type EACHRECEIVER';
