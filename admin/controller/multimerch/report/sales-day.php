...
class ControllerMultimerchReportSalesDay extends ControllerMultimerchReportbase {

	public function index() {
		$this->document->addScript('view/javascript/multimerch/report/sales-day.js');
		...
		$this->data['heading'] = $this->language->get('ms_menu_reports_sales_by_day');
		$this->document->setTitle($this->language->get('ms_menu_reports_sales_by_day'));
		...
		$this->data['breadcrumbs'] = $this->MsLoader->MsHelper->admSetBreadcrumbs(array(
			...
			array(
				'text' => $this->language->get('ms_menu_reports') . ' - ' . $this->language->get('ms_menu_reports_sales') . ' - ' . $this->language->get('ms_menu_reports_sales_by_day'),
				'href' => $this->url->link('multimerch/report/sales-day', '', 'SSL'),
			)
		));
		...
		$this->response->setOutput($this->load->view('multimerch/report/sales-day', $this->data));
	}
