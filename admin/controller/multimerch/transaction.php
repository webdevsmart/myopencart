...
class ControllerMultimerchTransaction extends ControllerMultimerchBase {
	...
	public function index() {
		...
		$this->data['link_create_transaction'] = $this->url->link('multimerch/transaction/create', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['breadcrumbs'] = $this->MsLoader->MsHelper->admSetBreadcrumbs(array(
			...
			array(
				...
				'href' => $this->url->link('multimerch/transaction', '', 'SSL'),
			)
		));
	...
	public function create() {
		...
		$this->data['breadcrumbs'] = $this->MsLoader->MsHelper->admSetBreadcrumbs(array(
			...
			array(
				...
				'href' => $this->url->link('multimerch/transaction/create', '', 'SSL'),
			)			
		));
