...
class ControllerExtensionShippingXshippingpro extends Controller {
	...
	private function getFormData($data)
	{
		...
		foreach($data['method_data'] as $single_method) {
			...
			if(!isset($method_data['city_all']))$method_data['city_all']='';
			if(!isset($method_data['city']))$method_data['city']='';
			if(!isset($method_data['city_rule']))$method_data['city_rule']='inclusive';
			...
			if(!isset($method_data['manufacturer_rule']))$method_data['manufacturer_rule']='1';
